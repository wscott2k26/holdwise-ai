...
export default function DailyChallengeHub() {
  ...
  return <div className="min-h-screen px-3 pt-[max(1rem,env(safe-area-inset-top))] text-white"><div className="mx-auto max-w-2xl"><div className="mb-3 flex justify-end"><SensoryControls/></div>
